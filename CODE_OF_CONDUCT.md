...
maintainers privately, using GitHub's private vulnerability reporting on this repository
(*Security* ▸ *Report a vulnerability*), which is the private channel available to us.
...
involved for a specified period of time. Violating these terms may lead to a temporary or
permanent ban.
